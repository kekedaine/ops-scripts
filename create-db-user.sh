...
#   curl -fsSL https://raw.githubusercontent.com/kekedaine/ops-scripts/blob/main/create-db-user.sh | bash -s <db_name> <user_name>
#
# Ví dụ:
#   curl -fsSL https://raw.githubusercontent.com/kekedaine/ops-scripts/blob/main/create-db-user.sh | bash -s mydb myuser
